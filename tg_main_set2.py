...
expName = 'tg_main_set2'  # from the Builder filename that created this script
...
instruction_text = visual.TextStim(win=win, name='instruction_text',
    text="Instructions\n\nOn each trial you will see 12 shapes called tangrams. \n\nThe tangrams are in the incorrect order.\n\nYour partner's screen contains the correct order. \n\nYou must work together to match your partners tangram order.",
    font='Arial',
...
text = visual.TextStim(win=win, name='text',
    text='On the next slide you will see 12 tangrams in an incorrect order. \n \nYour goal is to work with your partner to move your tangrams to match their correct order. \n \nOn each trial, do not press continue until your partner is ready to continue. \n \nClick anywhere to begin the first trial out of three.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
def win_checker()->bool:
    ...
    order2 = [hitbox_checker("one", gram24_4), 
                    hitbox_checker("two", gram14_4),
                    hitbox_checker("three", gram15_4),
                    hitbox_checker("four", gram16_4),
                    hitbox_checker("five", gram17_4),
                    hitbox_checker("six", gram18_4),
                    hitbox_checker("seven", gram19_4),
                    hitbox_checker("eight", gram20_4),
                    hitbox_checker("nine", gram21_4),
                    hitbox_checker("ten", gram22_4),
                    hitbox_checker("eleven", gram23_4),
                    hitbox_checker("twelve", gram13_4)]
    if all(order):
        return True
...
def win_checker()->bool:
    ...
    order2 = [hitbox_checker("one", gram13_5), 
                    hitbox_checker("two", gram23_5),
                    hitbox_checker("three", gram15_5),
                    hitbox_checker("four", gram16_5),
                    hitbox_checker("five", gram17_5),
                    hitbox_checker("six", gram18_5),
                    hitbox_checker("seven", gram19_5),
                    hitbox_checker("eight", gram20_5),
                    hitbox_checker("nine", gram21_5),
                    hitbox_checker("ten", gram22_5),
                    hitbox_checker("eleven", gram14_5),
                    hitbox_checker("twelve", gram24_5)]
    if all(order):
        return True
...
def win_checker()->bool:
    ...
    order2 = [hitbox_checker("one", gram13_6), 
                    hitbox_checker("two", gram14_6),
                    hitbox_checker("three", gram22_6),
                    hitbox_checker("four", gram16_6),
                    hitbox_checker("five", gram17_6),
                    hitbox_checker("six", gram18_6),
                    hitbox_checker("seven", gram19_6),
                    hitbox_checker("eight", gram20_6),
                    hitbox_checker("nine", gram21_6),
                    hitbox_checker("ten", gram15_6),
                    hitbox_checker("eleven", gram23_6),
...
def win_checker()->bool:
    ...
    order2 = [hitbox_checker("one", gram12), 
                    hitbox_checker("two", gram02),
                    hitbox_checker("three", gram03),
                    hitbox_checker("four", gram04),
                    hitbox_checker("five", gram05),
                    hitbox_checker("six", gram06),
                    hitbox_checker("seven", gram07),
                    hitbox_checker("eight", gram08),
                    hitbox_checker("nine", gram09),
                    hitbox_checker("ten", gram10),
                    hitbox_checker("eleven", gram11),
                    hitbox_checker("twelve", gram01)]
    if all(order):
        return True
...
def win_checker()->bool:
    ...
    order2 = [hitbox_checker("one", gram01_2), 
                    hitbox_checker("two", gram11_2),
                    hitbox_checker("three", gram03_2),
                    hitbox_checker("four", gram04_2),
                    hitbox_checker("five", gram05_2),
                    hitbox_checker("six", gram06_2),
                    hitbox_checker("seven", gram07_2),
                    hitbox_checker("eight", gram08_2),
                    hitbox_checker("nine", gram09_2),
                    hitbox_checker("ten", gram10_2),
                    hitbox_checker("eleven", gram02_2),
                    hitbox_checker("twelve", gram12_2)]
    if all(order):
        return True
