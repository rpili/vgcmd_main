...
expName = 'tg_main'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\rjpil\\OneDrive\\GS\\CECLAB\\vgcmd_main\\tg_main.py',
...
def win_checker()->bool:
    ...
    order2 = [hitbox_checker("one", gram13_6), 
                    ...
                    hitbox_checker("ten", gram22_6),
                    hitbox_checker("eleven", gram14_6),
                    hitbox_checker("twelve", gram24_6)]
    if all(order2):
        return True
