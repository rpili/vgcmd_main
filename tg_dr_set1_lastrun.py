...
expName = 'tg_dr_set1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\rjpil\\OneDrive\\GS\\CECLAB\\vgcmd_main\\tg_dr_set1_lastrun.py',
